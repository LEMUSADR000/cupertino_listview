...
class CupertinoChildListDelegate extends CupertinoListDelegate {
  ...
  CupertinoChildListDelegate({required this.children, required this.floatingSectionBuilder})
      : _keysToIndex = {},
  ...
  void setup() {
    super.setup();
    final flatList = children.fold(<Widget>[], (List<Widget> list, section) => list + section);
    Widget child;
